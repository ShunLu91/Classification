...
parser.add_argument('--exp_name', type=str, default='resnet50', help='search model name')
...
parser.add_argument('--data_dir', type=str, default='../dataset/herb_fingerprint', help='dataset dir')
